...
<body id="top">
    ...
    <div class="site-wrap">
        ...
        <section class="home-section section-hero overlay bg-image"
            style="background-image: url('welcome/images/hero_1.jpg');" id="home-section">
                ...
                <ul class="job-listings mb-5">
                    <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                        ...
                        <div class="job-listing-logo">
                            <img src="welcome/images/job_logo_1.jpg" alt="Free Website Template by Free-Template.co"
                                class="img-fluid">
                        </div>
                    ...
                    <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                        <a href="job-single.html"></a>
                        <div class="job-listing-logo">
                            <img src="welcome/images/job_logo_3.jpg" alt="Free Website Template by Free-Template.co"
                                class="img-fluid">
                        </div>
                    ...
                    <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                        <a href="job-single.html"></a>
                        <div class="job-listing-logo">
                            <img src="welcome/images/job_logo_4.jpg" alt="Free Website Template by Free-Template.co"
                                class="img-fluid">
                        </div>
                    ...
                    <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                        <a href="job-single.html"></a>
                        <div class="job-listing-logo">
                            <img src="welcome/images/job_logo_5.jpg" alt="Free Website Template by Free-Template.co"
                                class="img-fluid">
                        </div>
            ...
            <div class="owl-carousel single-carousel">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 align-self-end text-center text-lg-right">
                            <img src="welcome/images/person_transparent_2.png" alt="Image" class="img-fluid mb-0">
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 align-self-end text-center text-lg-right">
                            <img src="welcome/images/person_transparent.png" alt="Image" class="img-fluid mb-0">
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 ml-auto align-self-end">
                        <img src="welcome/images/apps.png" alt="Free Website Template by Free-Template.co" class="img-fluid">
                    </div>
                </div>
            </div>
        </section>
